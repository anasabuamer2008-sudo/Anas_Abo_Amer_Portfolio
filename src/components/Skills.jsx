...
const TABS = [
  { id: "life-sciences", key: "tab_life_sciences", icon: "\u{1F9EC}" },
  { id: "leadership", key: "tab_leadership", icon: "\u{1F465}" },
  { id: "media", key: "tab_media", icon: "\u{1F4F8}" },
];

const SKILLS = {
  "life-sciences": [
    { icon: "\u{1F9EC}", nameKey: "skill_biology", descKey: "skill_biology_desc" },
    { icon: "\u{1F52C}", nameKey: "skill_research", descKey: "skill_research_desc" },
    { icon: "\u{1F3E5}", nameKey: "skill_medicine", descKey: "skill_medicine_desc" },
  ],
  leadership: [
    { icon: "\u{1F465}", nameKey: "skill_leadership", descKey: "skill_leadership_desc" },
    { icon: "\u{1F91D}", nameKey: "skill_communication", descKey: "skill_communication_desc" },
    { icon: "\u{1F504}", nameKey: "skill_adaptability", descKey: "skill_adaptability_desc" },
  ],
  media: [
    { icon: "\u{1F4F8}", nameKey: "skill_media", descKey: "skill_media_desc" },
    { icon: "\u{1FA79}", nameKey: "skill_firstaid", descKey: "skill_firstaid_desc" },
  ],
};
